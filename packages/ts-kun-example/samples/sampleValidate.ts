...
export function validate<T extends keyof Mapper>(type: T, value: unknown): value is Mapper[T] { switch (type) {
    ...
    case "SampleUser2": return typeof value === "object" && value !== null && "id" in value && "age" in value && "email" in value && typeof value.id === "string" && typeof value.age === "number" && typeof value.email === "string";
} return false; }
